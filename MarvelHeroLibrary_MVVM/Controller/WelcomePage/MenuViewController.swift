...
class MenuViewController: UIViewController, UITableViewDelegate, UITableViewDataSource
{
    ...
    func configureTableView()
    {
        ...
        tableView.register(ManuOptionsTableViewCell.self, forCellReuseIdentifier: AppContains.StoryBoardContains.menuCellID)
    ...
    {
        let cell = tableView.dequeueReusableCell(withIdentifier: AppContains.StoryBoardContains.menuCellID, for: indexPath) as! ManuOptionsTableViewCell
